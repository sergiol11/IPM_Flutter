...
class _MyHomePageState extends State<MyHomePage> {
  ...
  ListaOpciones lista = ListaOpciones();
  List<Opcion> selectedDietaList = [];
  ...
  Future<void> _openFilterDialog() async {
    await FilterListDialog.display<Opcion>(
      ...
      themeData: FilterListThemeData(context),
      headlineText: 'Select Diet Items',
      height: 500,
      listData: lista._dietas,
      selectedListData: selectedDietaList,
      ...
      onApplyButtonClick: (list) {
        setState(() {
          selectedDietaList = List.from(list!);
        });
        Navigator.pop(context);
      },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(    ///AHI ESTÁ O CORPO É O QUE INTERESA MANNNNNNN!!!!
        children: <Widget>[
